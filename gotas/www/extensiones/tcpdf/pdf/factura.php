...
// Suprimir warnings de tipo E_DEPRECATED por incompatibilidad con PHP 8
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:540px">Vendedor: $vendedor[nombre]</td>
