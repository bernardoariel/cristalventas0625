...
class ControladorPresupuesto{
	...
	static public function ctrMostrarProductosPresupuesto($item, $valor){

		$tabla = "productos_presupuesto";

		$respuesta = ModeloPresupuesto::mdlMostrarProductosPresupuesto($tabla, $item, $valor);
