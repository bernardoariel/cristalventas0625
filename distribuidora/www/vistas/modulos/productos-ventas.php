          ...
          foreach ($facturas as $key => $value) {
            ...
            $productos =  json_decode($value["productos"], true);
              ...
              foreach ($productos as $key => $valueProductos) {
                ...
                // Validar si $producto es un array antes de acceder a sus elementos
                if (is_array($producto)) {
                  ...
                  // Validar si $categoria es un array antes de acceder a sus elementos
                  if (is_array($categoria)) {
                    echo $categoria['categoria'];
                  } else {
                    echo "Categoría no encontrada"; // O algún otro valor por defecto
                  }
                } else {
                  echo "Producto no encontrado"; // O algún otro valor por defecto
                }
