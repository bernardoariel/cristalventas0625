...
static public function mdlIngresarProducto($tabla, $datos){
	...
	"INSERT INTO $tabla (
		id_categoria, codigo, nombre, descripcion, stock,
		precio_compra, precio_venta, proveedor, cantminima
	) VALUES (
		:id_categoria, :codigo, :nombre, :descripcion, :stock,
		:precio_compra, :precio_venta, :proveedor, :cantminima
	)"
...
$stmt->bindParam(":cantminima", $datos["cantminima"], PDO::PARAM_STR);
	...
	if($stmt->execute()){
		...
		return $stmt->errorInfo(); // 👈 devuelvo el error para debug si lo necesitás
	}
