          ...
          <div class="box-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoDocumento" placeholder="Ingresar documento" maxlength="10" pattern="[0-9]{1,10}" title="Ingrese solo números, máximo 10 dígitos" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <!-- ENTRADA PARA LA TIPO DE IVA -->
                 ...
                 <select class="form-control input-lg" name="nuevoTipoIva" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control input-lg" name="nuevoEmail" placeholder="Ingresar email" value="email@email.com" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoTipoCliente" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoObs" placeholder="Ingresar Comentario" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarDocumento" id="editarDocumento" placeholder="Ingresar documento" maxlength="10" pattern="[0-9]{1,10}" title="Ingrese solo números, máximo 10 dígitos" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <!-- ENTRADA PARA LA TIPO DE IVA -->
                 ...
                 <select class="form-control input-lg" name="editarTipoIva" id="editarTipoIva" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="editarTipoCliente" id="editarTipoCliente" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarObs" id="editarObs" placeholder="Ingresar Comentario" required>
