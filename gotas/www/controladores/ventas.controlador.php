			...
			foreach ($ventas as $row => $item){
				...
				$vendedor = ControladorUsuarios::ctrMostrarUsuarios("id", $item["id_vendedor"]);
			 	...
			 	$output_html .= "<tr>
			 			...
			 			<td style='border:1px solid #eee;'>".mb_convert_encoding($item["codigo"], 'UTF-8', 'auto')."</td> 
			 			<td style='border:1px solid #eee;'>".mb_convert_encoding($cliente["nombre"], 'UTF-8', 'auto')."</td>
			 			<td style='border:1px solid #eee;'>".mb_convert_encoding($vendedor["nombre"], 'UTF-8', 'auto')."</td>
			 	...
			 	foreach ($productos as $key => $valueProductos) {
		 			...
		 			$output_html .= mb_convert_encoding($valueProductos["cantidad"], 'UTF-8', 'auto')."&#10;";
			 	}

			 	$output_html .= "</td><td style='border:1px solid #eee;'>";	

		 		foreach ($productos as $key => $valueProductos) {
			 			
		 			$output_html .= mb_convert_encoding($valueProductos["descripcion"], 'UTF-8', 'auto')."&#10;";
		 		...
		 		$output_html .= "</td>
					...
					<td style='border:1px solid #eee;'>".mb_convert_encoding($item["metodo_pago"], 'UTF-8', 'auto')."</td>
					<td style='border:1px solid #eee;'>".mb_convert_encoding($item["referenciapago"], 'UTF-8', 'auto')."</td>
		 			</tr>";
...
static public function ctrRealizarPagoVenta(){
	...
	public static function ctrSumaTotalVentasEntreFechas($fechaInicial,$fechaFinal){
	...
	public static function ctrUltimoComprobante($item,$valor){
...
static public function ctrbKVentas($tabla, $item, $valor,$tipo){
	...
	static public function ctrContarVentasRango($fechaInicial, $fechaFinal){
