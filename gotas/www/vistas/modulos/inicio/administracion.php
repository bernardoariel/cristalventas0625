...
$(document).ready(function() {
  console.log('Script cargado en administracion gotas');
  
  // Verificar si el botón existe
  if($('#daterange-btn-caja').length > 0) {
    console.log('Botón encontrado en administracion gotas');
  } else {
    console.log('Botón NO encontrado en administracion gotas');
    return;
  }
  
  // Verificar si daterangepicker está disponible
  if(typeof $.fn.daterangepicker === 'undefined') {
    console.log('Daterangepicker NO está disponible en administracion gotas');
    return;
  } else {
    console.log('Daterangepicker está disponible en administracion gotas');
  }
  ...
  console.log('Daterangepicker inicializado en administracion gotas');
});
</script>
