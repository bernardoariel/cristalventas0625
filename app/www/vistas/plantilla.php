...
require_once "config/tenants.php";
...
<head>
 ...
 <title><?php echo APP_NAME; ?></title>
  ...
  #back {
    ...
    width:100%;
    height:100vh;
    background-image: url('<?php echo PLANTILLA_BACK; ?>');
...
<body class="hold-transition <?php echo SKIN_CLASS; ?> sidebar-mini">
<?php

// Definir rutas permitidas
$validRoutes = [
    "inicio", "usuarios", "categorias", "nube", "pagos", "empresa", "miempresa", "productos", "productosNJ", 
    "caja", "cajaNJ", "devolucion", "devolucionNJ", "update", "presupuestos", "editar-presupuesto", "restaurar", 
...
if(isset($_GET["ruta"]) && $_GET["ruta"] == "buscador") {
    include "modulos/buscador/index.php";
} 
// Verificar si hay sesión iniciada con pruebaOK
elseif(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "pruebaOK") {

    echo '<div class="wrapper">';
    include "modulos/cabezote.php";
    include "modulos/menu.php";

    if(in_array($_GET["ruta"], $validRoutes)) {
