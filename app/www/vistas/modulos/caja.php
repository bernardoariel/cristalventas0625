...
// Validar que $caja tenga datos
$cajaData = !empty($caja) && isset($caja[0]) ? $caja[0] : [
    'efectivo' => 0,
    'tarjeta' => 0,
    'cuenta_corriente' => 0,
    'vale' => 0,
...
// Validar que $ventas tenga datos
$ventasData = !empty($ventas) && isset($ventas["total"]) ? $ventas["total"] : 0;
     ...
     <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$<?php echo number_format($cajaData['efectivo'],2); ?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$<?php echo number_format($cajaData['tarjeta'],2); ?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$<?php echo number_format($cajaData['cuenta_corriente'],2); ?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$<?php echo number_format($cajaData['vale'],2); ?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$<?php echo number_format($cajaData['cheque'],2); ?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$<?php echo number_format($cajaData['transferencia'],2); ?></span>
        ...
        <div class="col-md-3 col-sm-4 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              <h5></h5>
              <span class="info-box-text"><strong>Ventas $<?php echo '  '. number_format($ventasData,2); ?></strong></span>
              
             
              <span class="info-box-text">Total $<?php echo number_format($ventasData+$importeCtaCorriente,2); ?></span>
              <h6>(Ventas + Pagos)</h6>
            </div>
            <!-- /.info-box-content -->
          </div>
