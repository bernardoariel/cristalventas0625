...
class ControladorClientes{
	...
	static public function ctrCrearCliente(){
		...
		if(isset($_POST["nuevoCliente"])){
			...
			if (
    preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\/.,&*()\[\] \-_%#@!¿?\'`´Ç°ºª]+$/', $_POST["nuevoCliente"]) &&
    preg_match('/^[0-9]+$/', $_POST["nuevoDocumento"]) &&
    preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\/.,&*()\[\] \-_%#@!¿?\'`´Ç°ºª]+$/', $_POST["nuevaDireccion"])
) {
			   	$tabla = "clientes";
...
if (
    preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\/.,&*()\[\] \-_%#@!¿?\'`´Ç°ºª]+$/', $_POST["editarCliente"]) &&
    preg_match('/^[0-9]+$/', $_POST["editarDocumento"]) &&
    preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\/.,&*()\[\] \-_%#@!¿?\'`´Ç°ºª]+$/', $_POST["editarDireccion"])
) {
			   	$tabla = "clientes";
	...
	static public function ctrCrearClienteEnVenta(){
		...
		if(isset($_POST["nombreCliente"])){
			...
			if (
    preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\/.,&*()\[\] \-_%#@!¿?\'`´Ç°ºª]+$/', $_POST["nombreCliente"]) &&
    preg_match('/^[0-9]+$/', $_POST["nuevoDocumento"]) &&
    preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\/.,&*()\[\] \-_%#@!¿?\'`´Ç°ºª]+$/', $_POST["nuevaDireccion"])
) {
			   	$tabla = "clientes";
