...
class ModeloVentas{
	...
	static public function mdlRangoFechasVentas($tabla, $fechaInicial, $fechaFinal){
		...
		if($fechaInicial == null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE fecha = :fecha ORDER BY id DESC limit 60");
	...
	public static function mdlUltimoComprobante($tabla, $item, $valor){
	...
	static public function mdlContarVentasRango($tabla, $fechaInicial, $fechaFinal){
		...
		if($fechaInicial == null){
			...
			if($fechaFinalMasUno == $fechaActualMasUno){
				...
				$stmt = Conexion::conectar()->prepare("SELECT count(*) FROM $tabla WHERE fecha BETWEEN :fechaInicial AND :fechaFinalMasUno");
				...
				$stmt = Conexion::conectar()->prepare("SELECT count(*) FROM $tabla WHERE fecha BETWEEN :fechaInicial AND :fechaFinal");
